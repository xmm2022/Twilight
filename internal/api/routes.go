...
func (a *App) registerRoutes() {
	...
	a.add(http.MethodGet, "/api/v1/users/me/libraries", AuthUser, a.handleLibraries)
	a.add(http.MethodPut, "/api/v1/users/me/libraries/visibility", AuthUser, a.handleLibraries)
	...
	a.add(http.MethodGet, "/api/v1/system/admin/emby/libraries", AuthAdmin, a.handleLibraries)
	...
	a.add(http.MethodGet, "/api/v1/emby/libraries", AuthUser, a.handleLibraries)
	...
	a.add(http.MethodPut, "/api/v1/media/request/:request_id/status", AuthUser, a.handleUpdateMediaRequestStatus)
...
func (a *App) registerAdminRoutes() {
	...
	a.add(http.MethodGet, "/api/v1/admin/users/:uid/libraries", AuthAdmin, a.handleLibraries)
	a.add(http.MethodPut, "/api/v1/admin/users/:uid/libraries", AuthAdmin, a.handleLibraries)
	a.add(http.MethodPut, "/api/v1/admin/users/:uid/library-self-service", AuthAdmin, a.handleAdminLibrarySelfService)
	a.add(http.MethodPost, "/api/v1/admin/users/library-self-service/bulk-enable", AuthAdmin, a.handleBulkEnableLibrarySelfService)
...
func (a *App) registerStatsInviteSigninAnnouncementDemoRoutes() {
	...
	a.add(http.MethodGet, "/api/v1/demo/media/search", AuthPublic, a.handleMediaSearch)
