...
func (a *App) registerRoutes() {
	...
	a.add(http.MethodPost, "/api/v1/users/regcode/check", AuthPublic, a.handleRegcodeCheck)
	a.add(http.MethodPost, "/api/v1/users/telegram/register/bind-code", AuthPublic, a.handleRegisterBindCode)
	...
	a.add(http.MethodPost, "/api/v1/users/me/telegram/bind-code", AuthUser, a.handleUserBindCode)
