...
[![Go](https://img.shields.io/badge/Go-1.23+-00ADD8?logo=go&logoColor=white)](https://go.dev/) [![Next.js](https://img.shields.io/badge/Next.js-16-black?logo=next.js&logoColor=white)](https://nextjs.org/) [![License](https://img.shields.io/badge/License-MIT-yellow)](LICENSE)
...
> 项目默认使用者具备基础 Linux、Go、前端与 Emby/Jellyfin 运维能力。当前不提供官方 Docker 部署方案。
...
| [Go 后端说明](docs/GO_BACKEND.md) | Go 后端启动、配置、Redis 与验证说明 |
